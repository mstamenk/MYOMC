...
if [ "$QUEUE" == "condor" ]; then
    ...
    crun.py run_test_hhh_trigger $MYOMCPATH/test/HIG-Run3Summer22wmLHEGS-00046-fragment.py Run3Summer22wmLHE --outEOS "/eos/user/m/mstamenk/CxAOD31run/trigger-run3/hhh-sm" --keepMINI --keepNANO --nevents_job 10 --njobs 1 --env --pileup_file 
