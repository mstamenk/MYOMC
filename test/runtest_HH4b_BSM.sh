...
if [ "$QUEUE" == "condor" ]; then
    ...
    crun.py run_hh4b_bsm_trigger $MYOMCPATH/test/hh4b-kl5-fragment.py Run3Summer22wmLHE --outEOS "/eos/user/m/mstamenk/CxAOD31run/trigger-run3/hh4b-bsm" --keepMINI --keepNANO --nevents_job 1000 --njobs 200 --env --pileup_file 
