...
if [ "$QUEUE" == "condor" ]; then
    ...
    crun.py run_hh2b2tau_bsm_trigger $MYOMCPATH/test/hh2b2tau-kl5-fragment.py  Run3Summer22wmLHE --outEOS "/isilon/data/users/mstamenk/mc-for-trigger/samples/hh2b2tau-bsm" --keepMINI --keepNANO --nevents_job 5000 --njobs 50 --env --pileup_file 
