...
if [ "$QUEUE" == "condor" ]; then
    ...
    crun.py run_ttHcc $MYOMCPATH/test/ttHcc.py  Run3Summer22wmLHE --outEOS "/isilon/data/users/mstamenk/mc-for-trigger/samples/ttHcc" --keepNANO --nevents_job 3000 --njobs 100 --env --pileup_file --seed_offset 1000
